...
<template>
    <h1 class="text-4xl text-black font-semibold">Homepage</h1>
    <p>
    ...
    <div class="colors flex gap-2">
        <h3 class="text-xl">Seleziona tema</h3>

        <select name="" id="" v-model="store.state.theme" class="bg-neutral-200 rounded-md">
